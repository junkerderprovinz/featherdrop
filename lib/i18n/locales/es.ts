...
export const es: Translation = {
  ...
  "settings.stripMetadata": "Eliminar metadatos de fotos",
  "settings.stripMetadataHint": "EXIF y GPS, eliminados antes de cifrar",
  ...
  "result.manageTitle": "Enlace de gestión",
  "result.manageHint": "Mantenlo privado: sirve para eliminar el archivo compartido antes de que caduque.",
  "result.copyManage": "Copiar enlace de gestión",
  "manage.title": "Gestionar tu archivo compartido",
  "manage.loading": "Comprobando el archivo compartido…",
  "manage.intro": "Eliminarlo borra el archivo y su enlace de inmediato. No se puede deshacer.",
  "manage.delete": "Eliminar ahora",
  "manage.confirmDelete": "Haz clic de nuevo para confirmar",
  "manage.deleted": "Archivo compartido eliminado",
  "manage.deleteFailed": "Error al eliminar",
  "manage.notFound": "Este enlace de gestión no es válido, o el archivo compartido ya ha caducado o se ha eliminado.",
