...
export const sv: Translation = {
  ...
  "manage.intro": "Radering tar bort filen och dess länk omedelbart. Det går inte att ångra.",
  "manage.delete": "Radera nu",
  "manage.confirmDelete": "Klicka igen för att bekräfta",
  "manage.deleted": "Delning raderad",
  "manage.deleteFailed": "Radering misslyckades",
  "manage.notFound": "Den här hanteringslänken är ogiltig, eller så har delningen redan gått ut eller raderats.",
