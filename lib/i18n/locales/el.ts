...
export const el: Translation = {
  ...
  "result.manageTitle": "Σύνδεσμος διαχείρισης",
  "result.manageHint": "Κρατήστε τον ιδιωτικό — χρησιμοποιήστε τον για να διαγράψετε τον διαμοιρασμό πριν λήξει.",
  "result.copyManage": "Αντιγραφή συνδέσμου διαχείρισης",
  "manage.title": "Διαχείριση του διαμοιρασμού σας",
  "manage.loading": "Έλεγχος του διαμοιρασμού…",
  "manage.intro": "Η διαγραφή αφαιρεί αμέσως το αρχείο και τον σύνδεσμό του. Δεν αναιρείται.",
  "manage.delete": "Διαγραφή τώρα",
  "manage.confirmDelete": "Κάντε ξανά κλικ για επιβεβαίωση",
  "manage.deleted": "Ο διαμοιρασμός διαγράφηκε",
  "manage.deleteFailed": "Η διαγραφή απέτυχε",
  "manage.notFound": "Αυτός ο σύνδεσμος διαχείρισης δεν είναι έγκυρος, ή ο διαμοιρασμός έχει ήδη λήξει ή διαγραφεί.",
