...
export const fr: Translation = {
  ...
  "settings.stripMetadata": "Supprimer les métadonnées photo",
  "settings.stripMetadataHint": "EXIF & GPS, supprimées avant le chiffrement",
  ...
  "manage.intro": "La suppression retire le fichier et son lien immédiatement. C’est irréversible.",
  "manage.delete": "Supprimer maintenant",
  "manage.confirmDelete": "Cliquez à nouveau pour confirmer",
  "manage.deleted": "Partage supprimé",
  "manage.deleteFailed": "Échec de la suppression",
  "manage.notFound": "Ce lien de gestion est invalide, ou le partage a déjà expiré ou été supprimé.",
