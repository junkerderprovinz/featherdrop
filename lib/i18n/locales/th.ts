...
export const th: Translation = {
  ...
  "manage.intro": "การลบจะนำไฟล์และลิงก์ออกทันที ไม่สามารถยกเลิกได้",
  "manage.delete": "ลบเดี๋ยวนี้",
  "manage.confirmDelete": "คลิกอีกครั้งเพื่อยืนยัน",
  "manage.deleted": "ลบการแชร์แล้ว",
  "manage.deleteFailed": "ลบไม่สำเร็จ",
  "manage.notFound": "ลิงก์จัดการนี้ไม่ถูกต้อง หรือการแชร์หมดอายุหรือถูกลบไปแล้ว",
