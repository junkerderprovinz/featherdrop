...
export const he: Translation = {
  ...
  "manage.intro": "מחיקה מסירה את הקובץ ואת הקישור שלו מיד. לא ניתן לבטל פעולה זו.",
  "manage.delete": "מחק עכשיו",
  "manage.confirmDelete": "לחצו שוב לאישור",
  "manage.deleted": "השיתוף נמחק",
  "manage.deleteFailed": "המחיקה נכשלה",
  "manage.notFound": "קישור הניהול אינו תקין, או שהשיתוף כבר פג או נמחק.",
