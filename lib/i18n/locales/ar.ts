...
export const ar: Translation = {
  ...
  "manage.intro": "الحذف يزيل الملف ورابطه فورًا. لا يمكن التراجع عن ذلك.",
  "manage.delete": "احذف الآن",
  "manage.confirmDelete": "انقر مرة أخرى للتأكيد",
  "manage.deleted": "تم حذف المشاركة",
  "manage.deleteFailed": "فشل الحذف",
  "manage.notFound": "رابط الإدارة هذا غير صالح، أو أن المشاركة قد انتهت صلاحيتها أو حُذفت بالفعل.",
