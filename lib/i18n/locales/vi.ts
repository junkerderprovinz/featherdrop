...
export const vi: Translation = {
  ...
  "manage.intro": "Xóa sẽ gỡ bỏ tệp và liên kết của nó ngay lập tức. Không thể hoàn tác.",
  "manage.delete": "Xóa ngay",
  "manage.confirmDelete": "Nhấp lại để xác nhận",
  "manage.deleted": "Đã xóa chia sẻ",
  "manage.deleteFailed": "Xóa thất bại",
  "manage.notFound": "Liên kết quản lý này không hợp lệ, hoặc chia sẻ đã hết hạn hoặc bị xóa.",
